...
let s:N1   = [ '#dfe7e2' , '#526057' , 17  , 190 ]
let s:N2   = [ '#dfe7e2' , '#171c19' , 255 , 238 ]
let s:N3   = [ '#1c9aa0' , '#232a25' , 85  , 234 ]
...
let g:airline#themes#Atelier_SavannaDark#palette.normal_modified = {
      \ 'airline_c': [ '#b16139' , '#dfe7e2' , 255     , 53      , ''     ] ,
      \ }

let s:I1 = [ '#ecf4ee' , '#1c9aa0' , 17  , 45  ]
let s:I2 = [ '#ecf4ee' , '#55859b' , 255 , 27  ]
let s:I3 = [ '#1c9aa0' , '#232a25' , 15  , 17  ]
...
let g:airline#themes#Atelier_SavannaDark#palette.replace.airline_a = [ s:I2[0]   , '#55859b' , s:I2[2] , 124     , ''     ]
...
let s:V1 = [ '#ecf4ee' , '#55859b' , 232 , 214 ]
let s:V2 = [ '#ecf4ee' , '#1c9aa0' , 232 , 202 ]
let s:V3 = [ '#1c9aa0' , '#232a25' , 15  , 52  ]
...
let s:IA1 = [ '#526057' , '#171c19' , 239 , 234 , '' ]
let s:IA2 = [ '#526057' , '#171c19' , 239 , 235 , '' ]
let s:IA3 = [ '#526057' , '#171c19' , 239 , 236 , '' ]
...
let g:airline#themes#Atelier_SavannaDark#palette.inactive_modified = {
      \ 'airline_c': [ '#171c19' , '#78877d' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#Atelier_SavannaDark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#dfe7e2' , '#55859b' , 189 , 55  , ''     ],
      \ [ '#ecf4ee' , '#55859b' , 231 , 98  , ''     ],
      \ [ '#55859b' , '#ecf4ee' , 55  , 231 , 'bold' ])

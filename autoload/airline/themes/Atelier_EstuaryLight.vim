...
let s:N1   = [ '#e7e6df' , '#878573' , 17  , 190 ]
let s:N2   = [ '#f4f3ec' , '#929181' , 255 , 238 ]
let s:N3   = [ '#5b9d48' , '#e7e6df' , 85  , 234 ]
...
let g:airline#themes#Atelier_EstuaryLight#palette.normal_modified = {
      \ 'airline_c': [ '#a5980d' , '#302f27' , 255     , 53      , ''     ] ,
      \ }

let s:I1 = [ '#e7e6df' , '#5b9d48' , 17  , 45  ]
let s:I2 = [ '#f4f3ec' , '#5f9182' , 255 , 27  ]
let s:I3 = [ '#5b9d48' , '#e7e6df' , 15  , 17  ]
...
let g:airline#themes#Atelier_EstuaryLight#palette.replace.airline_a = [ s:I2[0]   , '#5f9182' , s:I2[2] , 124     , ''     ]
...
let s:V1 = [ '#e7e6df' , '#5f9182' , 232 , 214 ]
let s:V2 = [ '#f4f3ec' , '#5b9d48' , 232 , 202 ]
let s:V3 = [ '#5b9d48' , '#e7e6df' , 15  , 52  ]
...
let s:IA1 = [ '#5f5e4e' , '#929181' , 239 , 234 , '' ]
let s:IA2 = [ '#6c6b5a' , '#e7e6df' , 239 , 235 , '' ]
let s:IA3 = [ '#878573' , '#f4f3ec' , 239 , 236 , '' ]
...
let g:airline#themes#Atelier_EstuaryLight#palette.inactive_modified = {
      \ 'airline_c': [ '#22221b' , '#6c6b5a' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#Atelier_EstuaryLight#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#302f27' , '#5f9182' , 189 , 55  , ''     ],
      \ [ '#22221b' , '#5f9182' , 231 , 98  , ''     ],
      \ [ '#5f9182' , '#22221b' , 55  , 231 , 'bold' ])
